...
Also notice I left off `coef = 10` this time. Most of the highest-poverty counties are considered outliers, as they are more that 1.5 times the IQR away from the median. The `coef` variable changes the number of multiples of the IQR we need to be from the median before we call something an outlier. Use `help(geom_boxplot)` for more.
